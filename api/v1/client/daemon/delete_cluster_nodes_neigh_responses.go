...
func (o *DeleteClusterNodesNeighReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 206:
		result := NewDeleteClusterNodesNeighErrors()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewDeleteClusterNodesNeighErrors creates a DeleteClusterNodesNeighErrors with default headers values
func NewDeleteClusterNodesNeighErrors() *DeleteClusterNodesNeighErrors {
	return &DeleteClusterNodesNeighErrors{}
}

/*DeleteClusterNodesNeighErrors handles this case with default header values.
...
func (o *DeleteClusterNodesNeighErrors) Error() string {
	return fmt.Sprintf("[DELETE /cluster/nodes/neigh][%d] deleteClusterNodesNeighErrors  %+v", 206, o.Payload)
}

func (o *DeleteClusterNodesNeighErrors) GetPayload() int64 {
	return o.Payload
}

func (o *DeleteClusterNodesNeighErrors) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteClusterNodesNeighInvalid) Error() string {
	return fmt.Sprintf("[DELETE /cluster/nodes/neigh][%d] deleteClusterNodesNeighInvalid  %+v", 400, o.Payload)
}

func (o *DeleteClusterNodesNeighInvalid) GetPayload() models.Error {
	return o.Payload
}
